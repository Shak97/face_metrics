...
groundtruth_dir = r'/media/oem/storage01/Shakeel/aerial-segmentation/SAM_finetuning/abc/cycleGAN_all/final/deformable_cycleGAN_w_id/datasets/multipie/testB'
...
# # CFP dataset paths
# groundtruth_dir = r'/media/oem/storage01/Shakeel/aerial-segmentation/SAM_finetuning/abc/datasets/cfp-dataset/cfp-dataset/cfp_profile'
# predicted_dir = r'/media/oem/storage01/Shakeel/aerial-segmentation/SAM_finetuning/abc/datasets/cfp-dataset/cfp-dataset/cfp_profile_generated_deformable_lastlayer/'
